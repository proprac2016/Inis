...
class HorariosControllerTest < ActionController::TestCase
  ...
  test "should create horario" do
    assert_difference('Horario.count') do
      post :create, horario: { dia: @horario.dia, hora_fin: @horario.hora_fin, hora_inicio: @horario.hora_inicio }
    end
  ...
  test "should update horario" do
    patch :update, id: @horario, horario: { dia: @horario.dia, hora_fin: @horario.hora_fin, hora_inicio: @horario.hora_inicio }
    assert_redirected_to horario_path(assigns(:horario))
  end
